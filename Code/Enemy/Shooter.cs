...
public class Shooter : MonoBehaviour, IEnemy
{
    ...
    //adjust the parameter to certain range
    ...
    //routine of shooting bullet to attack
    ...
    //the spread angle and move direction of the bullet implement
